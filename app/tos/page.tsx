...
const page = () => {
  return (
    <>
    <NavBar/>
    <div className="text-white items-center  flex flex-col gap-3 font-semibold p-20 font-mono ">
      <h2 className="text-5xl">
        <strong>Terms and Conditions</strong>
      </h2>

      <p className="text-3xl">Welcome to Vilo!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Vilo's Website, located at https://vilo.fun.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Vilo if you do not agree to take all
      ...
      <p>
        ...
        subject to, prevailing law of ru. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing Vilo, you agreed to use
        cookies in agreement with the Vilo's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Vilo and/or its licensors own the intellectual
        property rights for all material on Vilo. All intellectual property
        rights are reserved. You may access this from Vilo for your own personal
        use subjected to restrictions set in these terms and conditions.
      </p>

      <p className="text-3xl">You must not:</p>
      <ul>
        <li>Republish material from Vilo</li>
        <li>Sell, rent or sub-license material from Vilo</li>
        <li>Reproduce, duplicate or copy material from Vilo</li>
        <li>Redistribute content from Vilo</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Vilo
        ...
        of Vilo,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Vilo shall not be liable for the Comments
      ...
      <p>
        Vilo reserves the right to monitor all Comments and to remove any
        Comments which can be considered inappropriate, offensive or causes
        breach of these Terms and Conditions.
      </p>

      <p className="text-3xl">You warrant and represent that:</p>
      ...
      <p>
        You hereby grant Vilo a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Vilo; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Vilo. Please include your name, your organization name,
      ...
      <p className="text-3xl">Approved organizations may hyperlink to our Website as follows:</p>
      ...
      <p>
        No use of Vilo's logo or other artwork will be allowed for linking
