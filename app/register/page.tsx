...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      console.error("Registration failed:",error,  error.response.data.response);
      ...
      <main className="flex min-h-screen flex-col items-center justify-center p-20">
        ...
        >
          ...
          <div className="items-center w-full flex">
            ...
            <input
              type="text"
              className="pl-[6.7rem] duration-300 w-full outline-none rounded-lg border-l-8 focus:border-l-cyan-500 border-transparent hover:border-l-gray-300 max-w-[500px] shadow-2xl font-light py-3 text-[#1a1a1a] text-lg"
              value={name}
          ...
          <button
            type="submit"
            className="text-white bg-black py-4 rounded-xl font-mono text-xl"
          >
            Register
          </button>
